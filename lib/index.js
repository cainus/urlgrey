...
class UrlGrey {
    constructor(url) {
        _UrlGrey_url.set(this, void 0);
        __classPrivateFieldSet(this, _UrlGrey_url, url, "f");
        this._parsed = null;
    }
    parsed() {
        if (this._parsed) {
        ...
        this._parsed = urlParse(__classPrivateFieldGet(this, _UrlGrey_url, "f"));
    ...
    child(suffixes) {
        return this.clearQuery().hash("").path([this.getPath(), suffixes].flat(5));
    }
    toJSON() {
...
exports.UrlGrey = UrlGrey;
_UrlGrey_url = new WeakMap();
const pathPieces = function (path) {
